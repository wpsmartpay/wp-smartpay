...
/**
 * Whether the button currently shows an icon (preset slug chosen, or a custom
 * media icon selected). Shared by the style builder and the preview.
 */
...
export const edit = ({ attributes, setAttributes }) => {
    ...
    const showIcon = hasSubmitIcon(attributes)
