...
<div class="smartpay <?php echo 'wrap-' . $active_tab; ?>">
    <div class="container">
        <div class="d-flex align-items-center justify-content-between py-1 px-4 mt-3 text-white bg-dark rounded-top">
            ...
            <div>
                <a class="btn btn-dark btn-sm" href="https://wpsmartpay.com/changelog/"
                    target="_blank">v<?php echo SMARTPAY_VERSION; ?></a>
            </div>
        </div>
            ...
            <div class="card-body">
                ...
                <form method="POST" action="options.php">
                    <table class="form-table">
						...
						if (true === $override) :
						?>
                        <input type="hidden" name="smartpay_section_override"
