        ...
        <div class="col-3 bg-light border-right">
            <div class="py-3">
                <div class="nav flex-column nav-pills" id="v-pills-tab" role="tablist" aria-orientation="vertical">
                    <a class="nav-link text-decoration-none d-flex align-items-center active" id="smartpay-files-tab"
                        data-toggle="pill" href="#smartpay-files" role="tab" aria-controls="smartpay-files"
                        aria-selected="true">
                        <i data-feather="hard-drive" width="14" height="14"></i> <span class="ml-2">Files</span>
                    </a>
                    <a class="nav-link text-decoration-none d-flex align-items-center" id="smartpay-pricing-tab"
                        data-toggle="pill" href="#smartpay-pricing" role="tab" aria-controls="smartpay-pricing"
                        aria-selected="false">
