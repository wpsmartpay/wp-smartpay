...
$form_id    = absint($payment->payment_data['form_id'] ?? 0);
$form       = new SmartPay_Form($form_id);
...
<body>
    <div style="margin: 0; padding: 0; width: 100%; word-break: break-word; -webkit-font-smoothing: antialiased; background-color: #f2f2f7">
                                                    ...
                                                    <tr>
                                                        <td class="sm-w-full sm-block sm-pb-32" style="font-weight: 400; text-align: left; vertical-align: top; width: 50%" align="left" valign="top">
                                                            ...
                                                            <p style="font-size: 16px; line-height: 24px; margin: 0; color: #4f5a68">
                                                                <?php echo __('Name:', 'smartpay') . ' ' . $customer_name; ?>
                                                                <br>
