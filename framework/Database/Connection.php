...
class Connection
{
    ...
    public function __construct($wpdb, array $config = array(), $alias = null, Container $container = null)
    {
        ...
        $this->eventHandler = $this->container->build('\\SmartPay\Framework\Database\\EventHandler');
    ...
    {
        class_alias('SmartPay\Framework\Database\\AliasFacade', $alias);

        $builder = $this->container->build('\\SmartPay\Framework\Database\\QueryBuilder\\QueryBuilderHandler', array($this));
    ...
    {
        return $this->container->build('\\SmartPay\Framework\Database\\QueryBuilder\\QueryBuilderHandler', array($this));
    }
