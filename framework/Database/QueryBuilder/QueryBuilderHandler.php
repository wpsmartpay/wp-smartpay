...
class QueryBuilderHandler
{
    ...
    /**
     * @var \SmartPay\Framework\Database\QueryBuilder\Adapters\BaseAdapter
     */
    ...
    public function query($sql, $bindings = array())
    {
        $this->dbStatement = $this->container->build(
            '\\SmartPay\Framework\Database\\QueryBuilder\\QueryObject',
            array($sql, $bindings)
        )->getRawSql();
    ...
    public function join($table, $key, $operator = null, $value = null, $type = 'inner')
    {
        ...
        $joinBuilder = $this->container->build('\\SmartPay\Framework\Database\\QueryBuilder\\JoinBuilder', array($this->connection));
    ...
    public function transaction(\Closure $callback)
    {
        try {
            ...
            $transaction = $this->container->build(
                '\\SmartPay\Framework\Database\\QueryBuilder\\Transaction',
                array($this->connection)
            );
    ...
    {
        return $this->container->build('\\SmartPay\Framework\Database\\QueryBuilder\\Raw', array($value, $bindings));
    }
