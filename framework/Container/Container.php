...
use Closure;
use Exception;
use SmartPay\Framework\Contracts\Container\BindingResolutionException;
use SmartPay\Framework\Contracts\Container\Container as ContainerContract;
use LogicException;
use ReflectionClass;
...
class Container implements ArrayAccess, ContainerContract
{
     ...
     * @return \SmartPay\Framework\Contracts\Container\ContextualBindingBuilder
     */
     ...
     * @return mixed
     */
    public function refresh($abstract, $target, $method) : mixed
    {
